    ...
    public boolean parseAttr(Resources res, AttributeSet attrs)
    {
        ...
        for (int i = 0; i < attrs.getAttributeCount(); i++)
        {
            ...
            if ("textColorHighlight".equals(name))
            {
                ...
                if (textColorHighlight != 0)
                {
                    skinManager.registerColorStateList(res, textColorHighlight);
                }
            }
            else if ("textColor".equals(name))
            {
                ...
                if (textColor != 0)
                {
                    skinManager.registerColorStateList(res, textColor);
                }
            }
            else if ("textColorHint".equals(name))
            {
                ...
                if (textColorHint != 0)
                {
                    skinManager.registerColorStateList(res, textColorHint);
                }
            }
            else if ("textColorLink".equals(name))
            {
                ...
                if (textColorLink != 0)
                {
                    skinManager.registerColorStateList(res, textColorLink);
                }
            }
            else if ("drawableLeft".equals(name))
            {
                ...
                if (drawableLeft != 0)
                {
                    skinManager.registerDrawable(res, drawableLeft);
                }
            }
            else if ("drawableTop".equals(name))
            {
                ...
                if (drawableTop != 0)
                {
                    skinManager.registerDrawable(res, drawableTop);
                }
            }
            else if ("drawableRight".equals(name))
            {
                ...
                if (drawableRight != 0)
                {
                    skinManager.registerDrawable(res, drawableRight);
                }
            }
            else if ("drawableBottom".equals(name))
            {
                ...
                if (drawableBottom != 0)
                {
                    skinManager.registerDrawable(res, drawableBottom);
                }
            }
            else if ("shadowColor".equals(name))
            {
                ...
                if (shadowColor != 0)
                {
                    skinManager.registerColorStateList(res, shadowColor);
                }
            }
            else if ("textCursorDrawable".equals(name))
            {
                ...
                {
                    skinManager.registerDrawable(res, textCursorDrawable);
                }
            }
        }
        return super.parseAttr(res, attrs) || (textColorHighlight | textColor | textColorHint | textColorLink | drawableLeft | drawableTop | drawableRight | drawableBottom |
                shadowColor |
                textCursorDrawable) != 0;
    }
}