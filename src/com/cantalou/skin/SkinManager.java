...
public class SkinManager
{
    ...
    private void changeActivityResources(Activity activity, Resources toRes)
    {
        ...
        {
            Log.v("change Activity:{} to Resources :{} ,result:{} ", activity, toRes, set(activity, "mResources", toRes));
        }
        else
        {
            Log.v("change Activity:{} to Resources :{} ,result:{} ", activity.getBaseContext(), toRes, set(activity, "mResources", toRes));
        }
