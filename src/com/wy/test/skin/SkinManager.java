...
public class SkinManager {
	...
	private Resources createProxyResource(Activity activity, String skinName) throws Exception {
		...
		Resources skinResources = createSkinResource(activity, skinName);
		res = new ProxyResources(activity, skinResources, defaultResources);
	...
	private void changeAll(Activity activity) {
		...
		for (Activity a : activityMaps.keySet()) {
			...
			if (a instanceof FragmentActivity) {
				List<Fragment> fragments = ((FragmentActivity) a).getSupportFragmentManager().getFragments();
