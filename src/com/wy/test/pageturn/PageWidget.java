...
public class PageWidget extends View
{
    ...
    public boolean doTouchEvent(MotionEvent event)
    {
        ...
        {
            mDownX = mTouch.x = event.getX();
            mDownY = mTouch.y = event.getY();
        }
    ...
    private boolean startRemoveCheck = false;
    ...
    public void computeScroll()
    {
        ...
        if (mScroller.isFinished() && startRemoveCheck)
        {
    ...
    {
        abortAnimation();
        ViewPropertyAnimator.animate(PageWidget.this)
                            .alpha(0F)
                            .setDuration(50)
                            .setListener(new AnimatorListenerAdapter()
                            {
                                ...
                                {
                                    ViewGroup parent = (ViewGroup) PageWidget.this.getParent();
                                    //parent.removeView(PageWidget.this);
                                }
                            });
    }
    ...
    private void startAnimation(int delayMillis)
    {
        ...
        delayMillis = mTouch.x > mWidth / 2 ? (int) (1F * delayMillis * mTouch.x / mWidth) : delayMillis / 2;
        mScroller.startScroll((int) mTouch.x, (int) mTouch.y, dx, dy, delayMillis);
        startRemoveCheck = true;
    ...
    {
        if (mCornerX > ViewConfiguration.get(getContext())
                                        .getScaledTouchSlop())
        {
            return false;
        }
    ...
    public boolean onTouchEvent(MotionEvent e)
    {
        ...
        {
            touchInArea = false;
            if (e.getX() > mWidth / 2 && !isAnimation())
            {
                touchInArea = true;
